...
namespace wawo { namespace net {
	...
	WWRP<channel_future> channel_handler_context::write_and_flush(WWRP<packet> const& outlet, WWRP<channel_promise> const& ch_promise) {
		WWRP<channel_future> ch_future = write(outlet,ch_promise);
		flush();
		return ch_future;
	}
