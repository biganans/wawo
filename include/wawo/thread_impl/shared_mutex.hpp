...
namespace wawo { namespace impl {
	...
	class shared_mutex
	{
		...
		wawo::condition m_shared_cond;
		wawo::condition m_exclusive_cond;
		wawo::condition m_upgrade_cond;
	...
	public:
		...
		void lock_shared() {
			wawo::unique_lock<_MyStateMutexT> ulck(m_state_mutex);
...
namespace wawo {
		...
		typedef wawo::_mutex_detail::shared_mutex<mutex> shared_mutex;
#else
		typedef wawo::impl::shared_mutex<mutex> shared_mutex;
#endif
}
#endif