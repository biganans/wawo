...
namespace wawo {
	...
	enum ErrorCodes {
		...
		E_CHANNEL_EXISTS				= -21006,
		E_CHANNEL_CLOSED_ALREADY		= -21007,

		E_SOCKET_GRACE_CLOSE								= -30000,
		E_SOCKET_SEND_IO_BLOCK_EXPIRED						= -30001,
		E_SOCKET_CONNECTING									= -30002,

		E_SOCKET_INVALID_FAMILY								= -30012,
		E_SOCKET_INVALID_TYPE								= -30013,
		E_SOCKET_INVALID_ADDRESS							= -30014,
		E_SOCKET_INVALID_PROTOCOL							= -30015,
		E_SOCKET_UNKNOWN_ADDRESS_FORMAT						= -30016,
