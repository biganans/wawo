...
namespace wawo {
	...
	enum ErrorCodes {
		...
		E_TLP_HANDSHAKE_DONE								= -30015,
		E_TLP_HANDSHAKING									= -30016,
		E_TLP_INVALID_PACKET								= -30017,
		E_TLP_UNKNOWN_CIPHER								= -30018,
		E_TLP_HANDSHAKE_MESSAGE_CHECK_FAILED				= -30019,
		E_TLP_INVALID_STATE									= -30020,
		E_TLP_SOCKET_BROKEN									= -30021,
		E_TLP_TRY_AGAIN										= -30022,
