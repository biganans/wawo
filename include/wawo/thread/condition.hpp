...
namespace wawo { namespace thread {
	...
	public:
		...
		inline void notify_one() {
			impl::scoped_lock<impl::mutex> _internal_lock(&m_mtx);
			m_impl.notify_one();
		}
	...
	public:
		...
		inline void notify_one() {
			impl::scoped_lock<impl::spin_mutex> sl(&m_mtx);
			m_impl.notify_one();
		}
		inline void no_interrupt_notify_one() {
			m_impl.notify_one();
